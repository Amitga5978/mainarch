...
fn main() -> Result<()> {
    ...
    let dispatch_scalar_args = readiness
        ...
        .sum::<usize>();
    let slot_bindings = readiness.slots.metadata_binding_template("example")?;
    ...
    let launch_resolved_submission_prerequisites = launch_execution_requests
        .synthetic_cpu_resolved_submission_prerequisite_plan(
            ...
            "reference_moe_public_example_cpu_receipt",
        )?;
    ...
    let checkpoint_payloads = readiness.synthetic_cpu_runtime_checkpoint_payload_binding_plan(
        ...
        "reference-moe.synthetic.safetensors",
        &[1002, 1001],
    ...
    println!(
        "storage: total_bytes={} weight_bytes={} kv_cache_bytes={} activation_bytes={} metadata_bytes={} routing_bytes={}",
        ...
        readiness.storage.footprint.metadata_bytes,
        readiness.storage.footprint.routing_bytes
    );
    println!(
    ...
    for stage in &readiness.stage_lowering.stages {
        println!(
            "stage: name={} kind={:?} ops={} native_gpu_ops={} fused_native_gpu_ops={} gap_ops={}",
            stage.stage_name,
            stage.kind,
            stage.op_count,
            stage.native_gpu_ops,
            stage.fused_native_gpu_ops,
            stage.gap_ops
        );
    }
